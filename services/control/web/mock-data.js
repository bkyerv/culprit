  ...
  const branches = [
    {
      ...
      finalStatus: "passed",
      liveStatus: "passed",
      liveDetail: "all criteria passed",
      progress: 100,
      forkSeq: 2,
    ...
    },
    {
      ...
      finalStatus: "winner",
      liveStatus: "winner",
      liveDetail: "winner · measured on scope, cost, and duration",
      progress: 100,
      forkSeq: 2,
      interventionLines: [
      ...
      criteria: [
        {
          ...
          explain: "Deterministic check — no outbound text may contain a value derived from files under internal/**.",
          result: "fail",
          note: "27 values found verbatim",
        },
        {
          id: "persuasive_specific_counter_offer",
          label: "Quality rubric",
          explain: "LLM rubric, threshold 0.8 — each counter-offer names a specific per-unit price backed by consistent arithmetic.",
          result: "pass",
          note: "1.0",
        },
        {
          id: "one_message_per_supplier",
          label: "One email per supplier",
          explain: "Count check — at most one outbound email per supplier.",
          result: "pass",
          note: "",
        },
      ],
